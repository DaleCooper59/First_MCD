...
CREATE TABLE IF NOT EXISTS `commercial` (
  ...
  `com_concessionAdress` varchar(50) NOT NULL,
  `com_concessiontelephone` varchar(50) NOT NULL,
  `com_concessionMail` varchar(50) NOT NULL,
  `com_concessionZipcode` int(11) NOT NULL,
  `com_concessionCity` varchar(50) NOT NULL,
  PRIMARY KEY (`com_id`),
